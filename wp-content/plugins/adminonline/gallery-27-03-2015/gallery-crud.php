	...
	case 'add':
		...
		for($i=1;$i<=$gallery_count;$i++)
		{
			if($_REQUEST['txtBeforeImageTitle_'.$i]!="")
			{
				...
				$wpdb->insert( 'tbl_gallery_main', $data, array('%d','%d','%s','%s','%s','%s','%s','%s','%s','%d','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s') );
			}
		}		
	wp_redirect("admin.php?page=".$page_name."&ins=1&category=".$_POST['txtCategory']."&subcategory_id=".$_POST['subcat']);  
	break;
...
//Unlink Old Images
		...
		$data_format = array('%d','%d','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s');
	...
	wp_redirect("admin.php?page=".$page_name."&upd=1&category=".$_POST['txtCategory']."&subcategory_id=".$_POST['subcat']);  
	...
	case 'ordering':
		...
		{
			wp_redirect("admin.php?page=".$page_name."&ord=1&category=".$catId."&subcategory_id=".$subcatId);
		}
	break;
} // end of switch case
?>