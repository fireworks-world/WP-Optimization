...
<?php
	...
	if($searchText!='') {
	     ...
	     $where = " and (title LIKE %s OR title LIKE %s) ";
...
-->
          ...
          <th width="266" class="<?php echo $field_sort.' '.$class_sort; ?>">
		  	...
		  	<a href="<?php echo get_option('siteurl').'/wp-admin/admin.php?page='.$page_name.'&sort=testimony'; ?>&mode=<?php echo $mode; ?>&searchText=<?php echo $searchText; ?>&ipp=<?php echo $ipp; ?>&pval=<?php echo $pval; ?>" title="Sort by Title">
...
<?php
		  ...
		  <th width="240" class="<?php echo $field_sort.' '.$class_sort; ?>" >
<a href="<?php echo get_option('siteurl').'/wp-admin/admin.php?page='.$page_name.'&sort=status'; ?>&mode=<?php echo $mode; ?>&searchText=<?php echo $searchText; ?>&ipp=<?php echo $ipp; ?>&pval=<?php echo $pval; ?>" title="Sort by Status">

				<span>Status</span>	</a>	  </th>
...
<!--
          ...
          <td width="300"><?php 
			  	...
			  	$title = strip_tags($rec_list[$i]->title);
		 ...
		 ?>          </td>
          ...
          <td width="152" align="right" style="padding-right:8px;"><input type="checkbox" name="del" value="<?php echo $rec_list[$i]->$primary_key;?>" style="cursor:default" /></td>
