...
<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" id="manage_frm"  name="manage_frm" method="post">
  <div align="center" style="padding-bottom:10px;"><font color="#ff0000"><?php if($alert2){echo $alert2; }elseif($alert) { echo $alert;}?></font> </div>
  <div id="admin-top" style="padding-bottom:5px; padding-left:5px;">
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr class="td">
        ...
        <!--<td width="118"><label class="submit">
      ...
      <tbody>
        ...
        <tr id="<?php echo $rec_list[$i]->$primary_key; ?>">
          ...
          <td width="26%"><?php
			  	...
			  	$category_name = strip_tags($rec_list[$i]->category_name);
			 ...
			 <td width="10%"><?php $category_image = strip_tags($rec_list[$i]->category_image); ?>			   <a href="<?php echo UPLOAD_URL.$folder_name.'/'.$category_image; ?>" onclick="return false;" class="previews">View</a></td>
