...
error_reporting(E_ALL ^ E_NOTICE);
	...
	*/
	$query = "SELECT COUNT(*) as num FROM  tbl_videogallery where status='Y' ORDER BY ordering ";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages['num'];
	//print_r($total_pages);
	
	/* Setup vars for query. */
	$targetpage = get_option('siteurl').'/resources/video-gallery';
	...
	$sql_videogallery = "select * from   tbl_videogallery where status='Y' ORDER BY ordering asc LIMIT $start, $limit";
    $result_videogallery = mysql_query($sql_videogallery);
    $count_num_videogallery = mysql_num_rows($result_videogallery); 
