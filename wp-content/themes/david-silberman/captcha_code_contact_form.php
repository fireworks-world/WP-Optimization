...
$captcha_output_con = '<p style="margin:0px 0px 10px 0px ; padding:5px 0 0 0; line-height:18px; font-size:13px; font-family:Open Sans,sans-serif; color:#666; text-align:right;">Please select the <span style="color:#0da6e8; text-decoration:none; text-transform:uppercase;">'.ucwords($captcha_images_con[$random_con])."</span>  and click the SUBMIT button.</p>\n";
...
$captcha_output_con .= '<a href="javascript:void();" onClick="refreshCapchaContact();return false;"  alt="Refresh" title="Refresh" tabindex="108"><img class="refresh-contact" src="'.$imagePath.'refresh.png" border="0" alt="Refresh"   style=" margin:0px; float:right;"/></a>';
