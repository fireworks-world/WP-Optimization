...
<?php
        ...
        foreach($attachments as $att_id => $attachment) {
              if($attachment->ID){
               ...
               if($finalImage[1]>=400 && $finalImage[2]>=400){//width checking herre...Height checked for link building anatomy post. For Infographics only
